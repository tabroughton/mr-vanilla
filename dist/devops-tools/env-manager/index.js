...
exports.generateEnvVars = void 0;
const Mustache = __importStar(require("mustache"));
const template = __importStar(require("./env-cmdrc.template.json"));
const projectVars = __importStar(require("../../aerstudios-project.json"));
